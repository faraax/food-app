        ...
        <header className='fixed z-50 w-screen pt-5 p-2 px-4 md:p-6 md:px-16'>
            ...
            <div className='hidden md:flex w-full h-full'>
                ...
                <div className='relative'>
                    ...
                    {
                        isPending && (
                            <svg role="status" class="h-8 w-8 animate-spin ml-7 text-gray-200 dark:text-white fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
